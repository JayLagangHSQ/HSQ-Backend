...
router.post("/new",verify, verifyManager, shoutoutController.createNewShoutout);

// route for editing a shoutout
router.put("/:shoutoutId/edit", verify, verifyManager,verifyAllowedToChangeShoutout, shoutoutController.updateShoutout);

// route for deleting a shoutout
router.delete("/:shoutoutId/delete", verify, verifyManager,verifyAllowedToChangeShoutout, shoutoutController.deleteShoutout)
